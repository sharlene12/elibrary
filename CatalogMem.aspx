<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CatalogMem.aspx.vb" Inherits="CBELibrary4.CatalogMem" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <p id="log">
         <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="/images/u.png" Width="28px"
           ...
           <asp:Label ID="memb" runat="server" style="margin-top: 12px; margin-left: 16px;"></asp:Label>
            <asp:Button ID="Button2" runat="server" Text="logout" style="margin-top:12px; margin-left: 6px;" 
    ...
    <ul id="Ul1"  runat="server">
         ...
         <li><a class="act" href="CatalogMem.aspx">Catalog</a></li>
 ...
 <div id="Div1" style="margin-left:50px; border-color: antiquewhite;" >
        <asp:TextBox ID="tx1" runat="server" ForeColor="white" style="margin-left: 143px;" BackColor="#9393b2" Height="36px" Width="257px" Font-Size="16px" BorderColor="#5d5d8b" BorderStyle="Solid">Title</asp:TextBox>
        ...
        <asp:Button ID="Button1" CssClass="b1 bn" runat="server" style="margin-left: 24px;" BackColor="#FF9900" BorderColor="#FF9933" BorderStyle="Ridge" ForeColor="White" Height="41px" Text="Search" Width="166px" />
       </div>
        <br />
