<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="about.aspx.vb" Inherits="CBELibrary4.about" %>
...
<body>
    ...
    <ul runat="server">
        ...
        <li><a class="act" href="about.aspx">About</a></li>
    ...
    <div id="line2">
        ...
        <div class="grup">
            <img class="grup1" src="/images/sheya.jpg" style="margin-left: 100px; border-radius: 140px; margin-top: 60px" />
            &nbsp;
          <div class="middle1">
    ...
    <div id="coni">
        <img src="/images/deal.png" style="width: 600px; height: 600px; margin-left: 700px; margin-top: -700px" />
        &nbsp;
    </div>
